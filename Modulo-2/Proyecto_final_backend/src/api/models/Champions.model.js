...
const ChampionSchema = new Schema(
    {
        ...
        race:{type:String, enum:["ascendidos","celestial","cyborg","darkin","demonios","humanos","minotauros","nacidos del vacio", "nacidos en el hielo","renacido","vastaya","yeti","yordle"], required: true},
